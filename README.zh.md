...
最新构建版本在 [Releases](https://github.com/AlbertHuangT/discraft/releases/tag/latest)：
- `discraft-1.0.0.jar` — Fabric（需要 Fabric API）
...
# 产物：forge/build/libs/discraft-forge-1.0.0.jar
```
